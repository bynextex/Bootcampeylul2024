...
let dw = 29, dh = 32;
let dx = 20, dy = canvas.height / 2 - dh;
let mjh = dh * 2.2; // maximum jump height
...
function loadTrees() {
    ...
    trees = []; // yeniden basladiğinde eski agaçları sil
...
function baslat() {
    ...
    dy = canvas.height / 2 - dh; // dino zıplıyorsa zemine indir
    basladi = true;
